...
public class ExtAudioRecorder extends AppCompatActivity {
    ...
    private void RequestPermissions() {
        ...
        ActivityCompat.requestPermissions(ExtAudioRecorder.this, new String[]{RECORD_AUDIO, WRITE_EXTERNAL_STORAGE, MANAGE_EXTERNAL_STORAGE}, REQUEST_AUDIO_PERMISSION_CODE);
    }
...
//                }
            ...
            state = State.ERROR;
            Log.e(ExtAudioRecorder.class.getName(), "Here we are");
        }
        Log.e(ExtAudioRecorder.class.getName(), state + "--" + State.INITIALIZING);
    }

    /**
     * Sets output file path, call directly after construction/reset.
     *
     * @param  argPath outfile path
     *
     */
    public void setOutputFile(String argPath, File f) {
        try {
            ...
            if (state == State.INITIALIZING) {
                if (rUncompressed) {
                    if ((audioRecorder.getState() == AudioRecord.STATE_INITIALIZED) & (filePath != null)) {
                        ...
                        randomAccessWriter = new RandomAccessFile(fileObj, "rw");
